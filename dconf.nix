...

{
  dconf.settings = {
    "net/launchpad/plank/docks/dock1" = {
      ...
      dock-items = [ "applications.dockitem" "trash.dockitem" ];
    ...
    "org/cinnamon" = {
      ...
      enabled-applets = [ "panel1:left:0:menu@cinnamon.org:0" "panel1:left:2:separator@cinnamon.org:1" "panel1:right:6:systray@cinnamon.org:3" "panel1:right:7:xapp-status@cinnamon.org:4" "panel1:right:8:notifications@cinnamon.org:5" "panel1:right:9:printers@cinnamon.org:6" "panel1:right:10:removable-drives@cinnamon.org:7" "panel1:right:11:keyboard@cinnamon.org:8" "panel1:right:13:network@cinnamon.org:10" "panel1:right:15:power@cinnamon.org:12" "panel1:center:0:calendar@cinnamon.org:13" "panel1:right:17:cornerbar@cinnamon.org:14" "panel1:left:1:workspace-switcher@cinnamon.org:16" "panel1:right:3:sound150@claudiux:18" "panel1:right:2:weather@mockturtl:19" "panel1:left:4:temperature@fevimu:20" ];
      enabled-extensions = [ "transparent-panels@germanfr" ];
      next-applet-id = 22;
      panel-edit-mode = false;
      panel-zone-symbolic-icon-sizes = "[{\"panelId\": 1, \"left\": 30, \"center\": 28, \"right\": 16}]";
      panel-zone-text-sizes = "[{\"panelId\": 1, \"left\": 12.0, \"center\": 12.5, \"right\": 0.0}]";
    ...
    "org/cinnamon/desktop/background" = {
      picture-uri = "file:///home/gleb/Pictures/wallpaper.jpg";
    };

    "org/cinnamon/desktop/background/slideshow" = {
      delay = 15;
      image-source = "directory:///home/gleb/Pictures";
    };
    ...
    "org/cinnamon/desktop/interface" = {
      ...
      gtk-theme = "Mint-Y-Teal";
      icon-theme = "Mint-Y-Navy";
    ...
    "org/gtk/settings/file-chooser" = {
      ...
      window-position = mkTuple [ 531 195 ];
